                    ...
                    <form class="form-horizontal m-t " method="post" action="<?php echo U('add');?>">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select id="high_id">
                                    ...
                                    <?php if(is_array($high_level)): foreach($high_level as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["high_name"]); ?></option><?php endforeach; endif; ?>
                                </select>
                        ...
                        <!--<div class="form-group">-->
                            ...
                            <!--<div class="col-sm-9">-->
                                <!--<select name="middle_id" id="middle_id">-->
                                    <!--<option value="0">请选择中级类别</option>-->
                                    <!--<?php if(is_array($middle_level)): foreach($middle_level as $key=>$vo): ?>-->
                                        <!--<option value="<?php echo ($vo["id"]); ?>" <?php if(($vo["id"] == $data['middle_id'])): ?>selected<?php endif; ?> ><?php echo ($vo["middle_name"]); ?></option>-->
