                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            <!--表格开始    -->
                            <form action="/mr_navigation/index.php/Admin/Datalist/lists.html" method="post" name="updateSort" id="updateSort" >
                                ...
                                <div class="table-responsive">
                                    <table class="table  table-bordered table-hover">
                                        ...
                                        <?php if(is_array($datalists)): foreach($datalists as $key=>$vo): ?><tr>
                                                ...
                                                <td> <?php echo (get_parent_names($vo['id'])); ?> </td>
                                                <td>
                                                    <?php if(($vo["is_recommend"]) == "1"): ?>是<?php else: ?>否<?php endif; ?>
                                                </td>
                                                <td>
                                                    <?php if(($vo["is_hot"]) == "1"): ?>是<?php else: ?>否<?php endif; ?>
                                                </td>
