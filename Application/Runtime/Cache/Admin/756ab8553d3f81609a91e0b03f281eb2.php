                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <div class="row">
                                ...
                                <!--搜索开始-->
                                <form method="post" action="/mr_navigation/index.php/Admin/ElementaryLevel/lists.html" >
                                    <div class="col-sm-3">
                            ...
                            <!--表格开始    -->
                            <form action="/mr_navigation/index.php/Admin/ElementaryLevel/lists.html" method="post" name="updateSort" id="updateSort" >
                                ...
                                <div class="table-responsive">
                                    <table class="table  table-bordered table-hover">
                                        ...
                                        <?php if(is_array($datalists)): foreach($datalists as $key=>$vo): ?><tr>
                                                ...
                                                <td> <?php echo ($vo["elementary_name"]); ?></td>
                                                <td> <?php echo (get_parent_by_middle_id($vo["middle_id"])); ?> </td>
